...
const FLOW_STEPS_MAP = {
  1: [
    ...
    "runFlow when visible 'While using the app' → tapOn it",
    ...
    "assertVisible 'Login to your account|User Login|Browse|Home' (optional)",
    "takeScreenshot splash_onboarding_login_screen",
  ],
  2: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "tapOn 'User Login.*' (optional)",
    "waitForAnimationToEnd timeout:3000",
    "tapOn '.*\\+966.*' (optional)",
    "tapOn point:'50%, 13%'",
    "inputText 'Bangladesh'",
    "tapOn '.*\\+880.*' (optional)",
    "inputText '1316314566'",
  ...
  5: [
    ...
    "tapOn 'Verify' (optional)",
    "waitForAnimationToEnd timeout:8000",
    "tapOn 'Search for a service or provider' (optional)",
    "inputText 'Sarah'",
    "waitForAnimationToEnd timeout:3000",
    "tapOn 'Sarah Beauty Studio' (optional)",
    "waitForAnimationToEnd timeout:3000",
    "tapOn 'Choose Service' (optional)",
    "tapOn 'Add' (optional)",
    "tapOn 'Book Now' (optional)",
    "waitForAnimationToEnd timeout:3000",
  ...
  6: [
    ...
    "tapOn 'Book Now' (optional)",
    "waitForAnimationToEnd timeout:3000",
    "tapOn 'Choose Date and Time' (optional)",
    "tapOn 'Next' (optional)",
    "waitForAnimationToEnd timeout:5000",
    "takeScreenshot checkout_payment_selection",
    "tapOn 'Credit card' (optional)",
  ...
  25: [
    ...
    "tapOn 'Checkout' (optional)",
    "waitForAnimationToEnd timeout:5000",
    "tapOn 'Credit / Debit Card' (optional)",
  ...
  26: [
    ...
    "tapOn 'Verify' (optional)",
    "waitForAnimationToEnd timeout:8000",
    "takeScreenshot home_feed_loaded",
    "scrollDown",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot home_feed_scrolled_down",
    "tapOn 'Book Now' (optional)",
    "waitForAnimationToEnd timeout:3000",
    "pressKey Back",
    "takeScreenshot home_feed_complete",
  ],
  27: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "waitForAnimationToEnd timeout:3000",
    "tapOn 'Choose Service' (optional)",
    "takeScreenshot booking_service_selected",
    "tapOn 'Add' (optional)",
    "tapOn 'Book Now' (optional)",
    "waitForAnimationToEnd timeout:3000",
    "tapOn 'Choose Date and Time' (optional)",
    "tapOn 'Available Times' (optional)",
    "tapOn 'Next' (optional)",
    "waitForAnimationToEnd timeout:5000",
    "takeScreenshot booking_slot_selected",
    "tapOn 'Confirm Booking' (optional)",
    "waitForAnimationToEnd timeout:8000",
    "takeScreenshot booking_confirmed",
  ],
  28: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "tapOn 'Verify' (optional)",
    "waitForAnimationToEnd timeout:8000",
    "tapOn 'My Orders' / 'Bookings' (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot bookings_list",
    "tapOn 'Reschedule' (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot reschedule_picker",
    "tapOn available slot (optional)",
    "tapOn 'Confirm' (optional)",
    "waitForAnimationToEnd timeout:5000",
    "takeScreenshot reschedule_confirmed",
  ],
  29: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "tapOn 'My Orders' / 'Bookings' (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot orders_before_cancel",
    "tapOn 'Cancel' (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot cancel_dialog_shown",
    "tapOn 'Yes, Cancel' (optional)",
    "waitForAnimationToEnd timeout:5000",
    "takeScreenshot booking_cancelled",
  ],
  30: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "tapOn 'Verify' (optional)",
    "waitForAnimationToEnd timeout:8000",
    "tapOn notifications bell icon (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot notifications_panel_open",
    "tapOn first notification (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot notifications_complete",
  ],
  31: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "tapOn 'Verify' (optional)",
    "waitForAnimationToEnd timeout:8000",
    "tapOn 'Wallet' (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot wallet_screen",
    "tapOn 'History' (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot wallet_history",
    "tapOn 'Top Up' (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot wallet_topup_options",
    "pressKey Back",
    "takeScreenshot wallet_complete",
  ],
  32: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "waitForAnimationToEnd timeout:8000",
    "tapOn 'My Orders' (optional)",
    "tapOn 'Completed' tab (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot completed_orders_list",
    "tapOn first completed order (optional)",
    "waitForAnimationToEnd timeout:3000",
    "tapOn 'Rate' (optional)",
    "takeScreenshot rating_screen",
    "tapOn star 4 or 5 (optional)",
    "tapOn 'Submit' (optional)",
    "waitForAnimationToEnd timeout:5000",
    "takeScreenshot rating_submitted",
  ],
  33: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "tapOn 'Verify' (optional)",
    "waitForAnimationToEnd timeout:8000",
    "tapOn 'Map' / 'Near Me' (optional)",
    "waitForAnimationToEnd timeout:5000",
    "takeScreenshot map_loaded",
    "tapOn map pin (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot map_pin_tapped",
    "tapOn 'Directions' (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot map_complete",
  ],
  34: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "waitForAnimationToEnd timeout:8000",
    "tapOn 'Browse' (optional)",
    "tapOn favourite heart on a salon (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot favourite_added",
    "tapOn 'Favourites' tab (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot favourites_list",
    "tapOn heart again to remove (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot favourite_removed",
  ],
  35: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "tapOn 'Verify' (optional)",
    "waitForAnimationToEnd timeout:8000",
    "tapOn 'Refer a Friend' (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot referral_screen",
    "tapOn 'Share' (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot referral_share_dialog",
    "pressKey Back",
    "takeScreenshot referral_complete",
  ],
  36: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "tapOn 'Verify' (optional)",
    "waitForAnimationToEnd timeout:8000",
    "tapOn 'Profile' / 'Account' (optional)",
    "tapOn 'Appearance' / 'Theme' (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot appearance_settings",
    "tapOn 'Dark' toggle (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot dark_mode_enabled",
    "tapOn 'Light' toggle (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot light_mode_restored",
  ],
  37: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "tapOn 'Verify' (optional)",
    "waitForAnimationToEnd timeout:8000",
    "takeScreenshot home_a11y",
    "tapOn 'Browse' (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot a11y_nav_complete",
    "assertVisible accessibility labels (optional)",
    "takeScreenshot a11y_labels_verified",
  ],
  38: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "tapOn 'Verify' (optional)",
    "waitForAnimationToEnd timeout:8000",
    "takeScreenshot logged_in_before_background",
    "wait timeout:30000 (simulate idle)",
    "waitForAnimationToEnd timeout:5000",
    "takeScreenshot after_resume",
    "assertVisible 'Session expired' / 'Login' (optional)",
    "takeScreenshot session_timeout_complete",
  ],
  39: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "tapOn 'Verify' (optional)",
    "waitForAnimationToEnd timeout:8000",
    "tapOn 'Scan QR' / QR icon (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot qr_scanner_screen",
    "openLink 'mycoiffeur://booking/...' (deep link)",
    "waitForAnimationToEnd timeout:5000",
    "takeScreenshot deep_link_qr_complete",
  ],
  40: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "tapOn 'Skip' (optional)",
    "waitForAnimationToEnd timeout:5000",
    "assertVisible 'Update Available' (optional)",
    "tapOn 'Dismiss' / 'Later' (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot app_update_check_complete",
  ],
  41: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "tapOn 'Verify' (optional)",
    "waitForAnimationToEnd timeout:8000",
    "takeScreenshot salon_profile_home_loaded",
    "tapOn salon listing (optional)",
    "takeScreenshot salon_profile_listing",
    "tapOn salon card (optional)",
    "takeScreenshot salon_profile_opened",
    "assertVisible salon name / rating (optional)",
    "takeScreenshot salon_profile_info_visible",
    "scrollDown gallery (optional)",
    "takeScreenshot salon_profile_gallery_scrolled",
    "tapOn service (optional)",
    "takeScreenshot salon_profile_service_detail",
    "tapOn 'Reviews' tab (optional)",
    "takeScreenshot salon_profile_reviews_tab",
    "scrollDown reviews (optional)",
    "takeScreenshot salon_profile_reviews_scrolled",
    "takeScreenshot salon_profile_complete",
  ],
  42: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "tapOn 'Verify' (optional)",
    "waitForAnimationToEnd timeout:8000",
    "takeScreenshot search_filters_home_loaded",
    "inputText 'Hair' in search (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot search_results_hair",
    "tapOn 'Filter' (optional)",
    "tapOn category filter (optional)",
    "takeScreenshot search_filter_category_selected",
    "tapOn price range (optional)",
    "takeScreenshot search_filter_price_selected",
    "tapOn 'Sort: Nearest' (optional)",
    "takeScreenshot search_filter_sort_nearest",
    "tapOn 'Apply' (optional)",
    "takeScreenshot search_filtered_results",
    "tapOn 'Clear Filters' (optional)",
    "takeScreenshot search_filters_cleared",
    "inputText 'Massage' (optional)",
    "takeScreenshot search_results_massage",
    "takeScreenshot search_filters_complete",
  ],
  43: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "tapOn 'Verify' (optional)",
    "waitForAnimationToEnd timeout:8000",
    "takeScreenshot payment_methods_home_loaded",
    "tapOn 'Payment Methods' (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot payment_methods_list",
    "tapOn 'Add Card' (optional)",
    "takeScreenshot payment_add_card_form",
    "inputText card details (optional)",
    "takeScreenshot payment_card_form_filled",
    "tapOn 'Save Card' (optional)",
    "takeScreenshot payment_card_saved",
    "assertVisible saved card in list (optional)",
    "takeScreenshot payment_card_in_list",
    "tapOn 'Delete' on card (optional)",
    "tapOn 'Confirm' (optional)",
    "takeScreenshot payment_card_deleted",
    "takeScreenshot payment_methods_complete",
  ],
  44: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "tapOn 'Verify' (optional)",
    "waitForAnimationToEnd timeout:8000",
    "takeScreenshot wallet_topup_home_loaded",
    "tapOn 'Wallet' (optional)",
    "takeScreenshot wallet_topup_balance_screen",
    "tapOn 'Top Up' (optional)",
    "takeScreenshot wallet_topup_amount_screen",
    "tapOn '50 SAR' option (optional)",
    "takeScreenshot wallet_topup_50_selected",
    "tapOn 'Proceed to Payment' (optional)",
    "takeScreenshot wallet_topup_payment_selected",
    "tapOn 'Pay Now' (optional)",
    "takeScreenshot wallet_topup_processing",
    "waitForAnimationToEnd timeout:8000",
    "takeScreenshot wallet_topup_success",
    "takeScreenshot wallet_topup_complete",
  ],
  45: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "tapOn 'Verify' (optional)",
    "waitForAnimationToEnd timeout:8000",
    "takeScreenshot logout_home_loaded",
    "tapOn 'Profile' / 'Account' (optional)",
    "takeScreenshot logout_profile_screen",
    "scrollDown (optional)",
    "takeScreenshot logout_profile_scrolled",
    "tapOn 'Logout' (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot logout_dialog_appeared",
    "tapOn 'Yes' / 'Confirm' (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot logout_processing",
    "waitForAnimationToEnd timeout:5000",
    "takeScreenshot logout_login_screen_visible",
    "assertVisible 'Login' (optional)",
    "takeScreenshot logout_success_complete",
  ],
  46: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "tapOn 'Verify' (optional)",
    "waitForAnimationToEnd timeout:8000",
    "takeScreenshot edit_profile_home_loaded",
    "tapOn 'Profile' / 'Account' (optional)",
    "takeScreenshot edit_profile_profile_screen",
    "tapOn 'Edit Profile' (optional)",
    "takeScreenshot edit_profile_edit_screen",
    "clearText name field (optional)",
    "inputText 'Test User Updated'",
    "takeScreenshot edit_profile_name_entered",
    "tapOn avatar to change (optional)",
    "takeScreenshot edit_profile_avatar_option",
    "tapOn 'Save' (optional)",
    "waitForAnimationToEnd timeout:5000",
    "takeScreenshot edit_profile_saved",
    "assertVisible 'Test User Updated' (optional)",
    "takeScreenshot edit_profile_name_verified",
    "takeScreenshot edit_profile_complete",
  ],
  47: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "tapOn 'Continue' (optional)",
    "waitForAnimationToEnd timeout:5000",
    "takeScreenshot otp_resend_otp_screen_initial",
    "waitForAnimationToEnd timeout:5000",
    "takeScreenshot otp_resend_waiting",
    "tapOn 'Resend Code' (optional)",
    "takeScreenshot otp_resend_tapped",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot otp_resend_confirmation_visible",
    "inputText '1234'",
    "tapOn 'Verify' (optional)",
    "waitForAnimationToEnd timeout:8000",
    "takeScreenshot otp_resend_login_complete",
  ],
  48: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "tapOn 'Verify' (optional)",
    "waitForAnimationToEnd timeout:8000",
    "takeScreenshot location_permission_home_loaded",
    "tapOn 'Near Me' / map icon (optional)",
    "takeScreenshot location_permission_map_navigated",
    "tapOn 'Allow Location' / permission dialog (optional)",
    "waitForAnimationToEnd timeout:5000",
    "takeScreenshot location_permission_granted",
    "waitForAnimationToEnd timeout:5000",
    "takeScreenshot location_permission_map_loaded",
    "tapOn map pin (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot location_permission_pin_tapped",
    "takeScreenshot location_permission_complete",
  ],
  49: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "tapOn 'Verify' (optional)",
    "waitForAnimationToEnd timeout:8000",
    "takeScreenshot app_permissions_home_loaded",
    "tapOn 'Profile' (optional)",
    "tapOn 'Settings' / 'Permissions' (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot app_permissions_settings_screen",
    "tapOn 'Notifications' (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot app_permissions_notifications_screen",
    "tapOn notifications toggle ON (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot app_permissions_notification_toggled",
    "tapOn notifications toggle OFF (optional)",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot app_permissions_notification_retoggled",
    "takeScreenshot app_permissions_final_state",
  ],
  50: [
    "launchApp clearState:true",
    "waitForAnimationToEnd timeout:20000",
    ...
    "tapOn 'Verify' (optional)",
    "waitForAnimationToEnd timeout:8000",
    "takeScreenshot language_switch_home_loaded",
    "tapOn 'Profile' / 'Settings' (optional)",
    "tapOn 'Language' (optional)",
    "takeScreenshot language_switch_settings_screen",
    "tapOn language picker (optional)",
    "takeScreenshot language_switch_language_picker",
    "tapOn 'Arabic' / 'عربي' (optional)",
    "waitForAnimationToEnd timeout:5000",
    "takeScreenshot language_switch_arabic_applied",
    "assertVisible Arabic text (optional)",
    "takeScreenshot language_switch_arabic_layout",
    "assertVisible RTL layout (optional)",
    "takeScreenshot language_switch_rtl_verified",
    "tapOn 'English' to switch back (optional)",
    "waitForAnimationToEnd timeout:5000",
    "takeScreenshot language_switch_english_selected",
    "waitForAnimationToEnd timeout:3000",
    "takeScreenshot language_switch_english_restored",
    "takeScreenshot language_switch_complete",
  ],
};
